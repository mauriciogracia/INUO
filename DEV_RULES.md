...
* **CLI Version**: Governs the `inuo.sh` software shell implementation and tooling features.
* Bumping the `inuo.sh` CLI tool version does **NOT** change or break `SPEC_VERSION` unless the underlying interaction engine protocol itself changes.
